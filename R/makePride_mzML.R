makePridemzML <- function(currentMetadata, justRunUnitTest){

    .prideDir <- "pride/data/archive/2012/03/PXD000001/"
    .prideFullUrl <- paste0(.prideBaseUrl, .prideDir)
    fls <- "TMT_Erwinia_1uLSike_Top10HCD_isol2_45stepped_60min_01-20141210.mzML"

    .locationPrefix <- .prideBaseUrl

    .SourceType <- "mzML"
    .DispatchClass <- .RDataClass <- "mzRpwiz"
...
makeAnnotationHubResource("PXD000001MzMLToMzRPwizPreparer", makePridemzML )
