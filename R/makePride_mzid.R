makePride_mzid <- function(currentMetadata, justRunUnitTest=FALSE){

    .prideDir <- "pride/data/archive/2012/03/PXD000001/"
    .prideFullUrl <- paste0(.prideBaseUrl, .prideDir)
    fls <- "TMT_Erwinia_1uLSike_Top10HCD_isol2_45stepped_60min_01-20141210.mzid"

    .locationPrefix <- .prideBaseUrl

    .SourceType <- "mzid"
    .DispatchClass <- .RDataClass <- "mzRident"
...
makeAnnotationHubResource("PXD000001MzidToMzRidentPreparer", makePride_mzid )
