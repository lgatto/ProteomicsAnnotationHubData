...
- The `Recipe` is a short function, typically named
  ...
  converting the original file. Similarly, raw mass-spectrometry files
  are not converted into objects *per se*, but an accessor object is
  produced to extract data directly from the data file.
...
SourceUrl: http://s3.amazonaws.com/annotationhub/pride/data/archive/2012/03/PXD000001/
```
