...
files are detailed in the next section. The `writePahdTemplate`
...
and generated. See also the `r Biocpkg("AnnotationHub")` package for
additional documentation. Below is an excerpt of `PXD000001.dcf` 
...
The function that converts the data into its R data class.
